      ...
      <section className="bg-black text-white px-10 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col gap-4">
              {product.images.map((img, i) => (
                <img
                  ...
                  className={`w-20 h-20 object-contain border cursor-pointer ${activeImg === i ? "border-white" : "border-gray-700"
                    }`}
                />
              ))}
            </div>
          ...
          <div>
            ...
            <button
              ...
              className={`px-8 py-3 rounded text-sm cursor-pointer ${addedToCart ? "bg-green-600" : "bg-red-600 hover:bg-red-700"
                }`}
            >
              Add to cart
            </button>
        ...
        <div className="flex justify-center gap-10 mt-16 text-sm">
          <button
            ...
            className={activeTab === "specs" ? "text-white border-b-2 border-red-600 pb-1 cursor-pointer" : "text-gray-400 cursor-pointer"}
          >
            Specifications
          </button>
          <button
            onClick={() => setActiveTab("overview")}
            className={activeTab === "overview" ? "text-white border-b-2 border-red-600 pb-1 cursor-pointer" : "text-gray-400 cursor-pointer"}
          >
            Overview
          </button>
          <button
            onClick={() => setActiveTab("reviews")}
            className={activeTab === "reviews" ? "text-white cursor-pointer border-b-2 border-red-600 pb-1" : "text-gray-400 cursor-pointer"}
          >
            Reviews
          </button>
        </div>
        ...
        {/* RELATED PRODUCTS */}
        <div className="mt-24">
          <ProductsCards title="Related Products" products={relatedProducts} showFilters={false} showBrowseAll={false} />
        </div>
      </section>
